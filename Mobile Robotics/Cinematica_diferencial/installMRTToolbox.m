...
% installMRTToolbox Install and setup the Mobile Robotics Training Toolbox
% Syntax: >> installMRTToolbox
% This command installs the Mobile Robotics Training Toolbox and compiles
...
disp('***************************************');
disp('Mobile Robotics Training Toolbox');
...
if isempty(find(arrayfun(@(n)strcmp(tb(n).Name, 'Mobile Robotics Training Toolbox'), 1:numel(tb)),1))
    %Install MRT toolbox 
...
disp('(2/2) Compiling Real-Time Slower block...');
try
...
disp('(2/2) Compilation completed.')
