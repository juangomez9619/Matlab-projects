...
% figure(2), hold on;
% figure(2), plot(t(1:i-1),wP(1:i-1),'r','LineWidth',2);
% figure(2),title('Velocidad angular rad/s');
% figure(2), grid on;
% 
% figure(3),hold on;
% figure(3), plot(t(1:i-1),error_angular(1:i-1)*180/pi,'r','LineWidth',2);
% figure(3),title('Error angular °');
% figure(3), grid on;
% 
% figure(4),hold on;
% figure(4), grid on;
% figure(4), plot(t(1:i-1),theta(1:i-1),'r','LineWidth',2);
